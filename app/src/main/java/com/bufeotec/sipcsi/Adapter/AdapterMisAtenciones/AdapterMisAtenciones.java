...
public class AdapterMisAtenciones extends RecyclerView.Adapter<AdapterMisAtenciones.AtencionesViewHolder>{
    ...
    public AdapterMisAtenciones(Context context, ArrayList<Alertas> array, int layoutpadre, OnItemClickListener listener) {
        this.array = array;
    ...
    @NonNull
    @Override
    public AdapterMisAtenciones.AtencionesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(layoutpadre,parent,false);
        return new AdapterMisAtenciones.AtencionesViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterMisAtenciones.AtencionesViewHolder holder, int position) {
    ...
    public class AtencionesViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bid(final Alertas alertas,final AdapterMisAtenciones.OnItemClickListener listener){
